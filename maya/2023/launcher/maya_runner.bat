...
set PYTHONPATH=%SCRIPT_DIR%;%CORE_DIR%/third_party/;
set MAYA_MODULE_PATH=%CORE_DIR%/third_party/mgear_4.2.2/release;C:\Program Files\Epic Games\MetaHumanForMaya;
...
:: Actually open maya
set KEY_NAME="HKEY_LOCAL_MACHINE\SOFTWARE\Autodesk\Maya\2023\Setup\InstallPath"
